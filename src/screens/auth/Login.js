...
import { Content, Form, Item, Input, Label, Text, Button, CheckBox, FormControl, Stack, Container, Checkbox, Divider, Image, Center, KeyboardAvoidingView } from 'native-base';
...
const LoginScreen = ({ navigation, route }) => {
    ...
    const handleLogin = async () => {
        if (!email || !password) {
            alert('Ingrese su correo electrónico y/o contraseña');
            return;
        }
        setIsBussy(true);
        try {
